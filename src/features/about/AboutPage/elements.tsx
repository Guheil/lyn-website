...
export const StyledProfile = styled('div')(({ theme }) => ({ display: 'grid', gridTemplateColumns: '.86fr 1.14fr', gap: 'clamp(42px,7vw,100px)', '& .photo': { minHeight: 560, background: 'url("https://picsum.photos/seed/lyn-bactad-profile/1200/1500") center/cover' }, [theme.breakpoints.down('lg')]: { gridTemplateColumns: '1fr', '& .photo': { minHeight: 420 } } }));
